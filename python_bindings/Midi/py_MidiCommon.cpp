...
void init_MidiCommon(pybind11::module_& module)
{
   ...
   // autogen start
   pybind11::enum_<Midi::ControllerMessage> controllermessage(module, "MidiControllerMessage");
   ...
   controllermessage.value("RememberInit", Midi::ControllerMessage::RememberInit);
   ...
   controllermessage.value("DamperPedal", Midi::ControllerMessage::DamperPedal);
   ...
   controllermessage.value("User01", Midi::ControllerMessage::User01);
   ...
   controllermessage.value("AllSoundsOff", Midi::ControllerMessage::AllSoundsOff);
